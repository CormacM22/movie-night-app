...
function MovieCard({ movie, isTop, dragX, dragRotate }) {
  return (
    ...
    >
      ...
      <div style={{ padding: "16px 20px", height: "30%", display: "flex", flexDirection: "column", justifyContent: "space-between" }}>
        <div>
          <h2
            style={{
              fontFamily: "'Archivo Black', sans-serif",
...
function MatchScreen({ movie, onContinue }) {
  return (
    ...
    >
      ...
      <div style={{ width: "220px", height: "300px", marginBottom: "20px" }}>
